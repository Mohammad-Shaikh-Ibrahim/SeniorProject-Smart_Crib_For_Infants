...
model_audio = load_model('E:/Senior_Project/audio_classifier_mfcc_improved.h5')
CATEGORIES = ['Crying', 'Laugh', 'Noise', 'Silence']

model_cry_reason = load_model('E:/Senior_Project/sound_detection_modelCNN.h5')
classes = ['belly_pain', 'burping', 'cold-hot', 'discomfort', "dontKnow", 'hungry', 'lonely', 'scared', 'tired']

yolo_model = YOLO("yolo11n.pt")

# Connection to Firebase
cred = credentials.Certificate("E:/Senior_Project/RPi/smart-baby-nest-firebase-adminsdk.json")
